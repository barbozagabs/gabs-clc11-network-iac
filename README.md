...
| [aws_subnet.subnet_privada_1a](https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/resources/subnet) | resource |
| [aws_subnet.subnet_privada_1c](https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/resources/subnet) | resource |
| [aws_subnet.subnet_publica_1a](https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/resources/subnet) | resource |
| [aws_subnet.subnet_publica_1c](https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/resources/subnet) | resource |
| [aws_vpc.vpc_network](https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/resources/vpc) | resource |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_availability_zone_1a"></a> [availability\_zone\_1a](#input\_availability\_zone\_1a) | n/a | `string` | `"us-east-1a"` | no |
| <a name="input_availability_zone_1c"></a> [availability\_zone\_1c](#input\_availability\_zone\_1c) | n/a | `string` | `"us-east-1c"` | no |
| <a name="input_internet_gatewy"></a> [internet\_gatewy](#input\_internet\_gatewy) | n/a | `string` | `"igw_vpc_iac_clc11"` | no |
| <a name="input_subnet_privada_1a_range"></a> [subnet\_privada\_1a\_range](#input\_subnet\_privada\_1a\_range) | n/a | `string` | `"10.0.10.0/24"` | no |
| <a name="input_subnet_privada_1c_range"></a> [subnet\_privada\_1c\_range](#input\_subnet\_privada\_1c\_range) | n/a | `string` | `"10.0.100.0/24"` | no |
| <a name="input_subnet_publica_1a_range"></a> [subnet\_publica\_1a\_range](#input\_subnet\_publica\_1a\_range) | n/a | `string` | `"10.0.20.0/24"` | no |
| <a name="input_subnet_publica_1c_range"></a> [subnet\_publica\_1c\_range](#input\_subnet\_publica\_1c\_range) | n/a | `string` | `"10.0.200.0/24"` | no |
| <a name="input_vpc_name"></a> [vpc\_name](#input\_vpc\_name) | Nome da VPC criada via IAC | `string` | `"vpc_iac_clc11"` | no |
